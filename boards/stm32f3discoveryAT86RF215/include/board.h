 ...
 * @{
 */
#define AT86RF215_PARAM_SPI        SPI_DEV(1)       /* AT86RF215 on SPI3 */
#define AT86RF215_PARAM_CS         GPIO_PIN(PORT_A, 15)   /* PA15 */
#define AT86RF215_PARAM_INT        GPIO_PIN(PORT_C, 9)    /* PC9 */
#define AT86RF215_PARAM_RESET      GPIO_PIN(PORT_C, 8)    /* PC8 */
/** @} */
